...
namespace APIShift.AsepriteAnimationWorkflow {
    ...
    public class AsepriteImporterEditor : ScriptedImporterEditor {
        ...
        private void PivotPropField() {
            ...
            if ((SpriteAlignment) prop.enumValueIndex == SpriteAlignment.Custom) NoLabelPropField("_pivot");
        }
        ...
        private SerializedProperty GetProp(string propName) {
            return serializedObject.FindProperty($"{nameof(AsepriteImporter.Settings)}.{propName}");
        }
    }
}