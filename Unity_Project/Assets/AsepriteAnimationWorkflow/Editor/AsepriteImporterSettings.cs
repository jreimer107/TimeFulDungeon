...
namespace APIShift.AsepriteAnimationWorkflow {
    ...
    public class AsepriteImporterSettings {
        private const string CannotBeChanged = "(Cannot be changed for Aseprite imports)";
        ...
        [Tooltip(CannotBeChanged)] public TextureImporterType TextureType = TextureImporterType.Sprite;

        [Tooltip(CannotBeChanged)] public TextureImporterShape TextureShape = TextureImporterShape.Texture2D;

        [Tooltip(CannotBeChanged)] public SpriteImportMode SpriteMode = SpriteImportMode.Multiple;
        ...
        [Range(0, 32)] [Tooltip("How much empty area to leave around the sprite in the generated mesh.")]
        ...
        [Range(0, 32)] [Tooltip(CannotBeChanged)]
        ...
        public Vector2 PivotValue {
            get => _fixedPivots.TryGetValue(Pivot, out var result) ? result : _pivot;
            set => _pivot = value;
        }
    }
}